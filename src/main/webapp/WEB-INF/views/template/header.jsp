		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 additional-shop-info">
				<ul class="list-unstyled list-inline">
					<li><i class="fa fa-phone"></i><span>+aaa</span></li>
				...
				<ul class="list-unstyled list-inline pull-right">
					...
					<c:choose>
						<c:when test="${authenticated}">
							...
							<li><a href="<%=request.getContextPath()%>/admin/"> ${pageContext.request.userPrincipal.name}</a></li>
						...
						<c:otherwise>
							<li><a href="<%=request.getContextPath()%>/login">Giriş Yap</a></li>
							<li><a href="<%=request.getContextPath()%>/user/registeruser">Kaydol</a></li>
						</c:otherwise>
					</c:choose>
					</sec:authorize>
